...
public class MapCreatorManager : MonoBehaviour
{
    ...
    public void loadMapFromXml()
    {
        ...
        MapContainer container = ObjectSaveLoad.JsonLoad<MapContainer>(file + ".txt");
